...
Get the list of available targets for an android environment." t nil)
...
Start Android's ddms debugging proxy." t nil)

(autoload 'cedet-android-adb-help "cedet-android" "\
Get help for Android Debug Bridge." t nil)

(autoload 'cedet-android-adb-devices "cedet-android" "\
The the list of attached devices from Android Debug Bridge." t nil)
...
Create an inferior shell for Android Debug Bridge." t nil)

(autoload 'cedet-android-sdk-update-classpath "cedet-android" "\
Update the classpath for `cedet-java' to include the android compile-time libraries." t nil)

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "cedet-android" '("cedet-android-")))

;;;***

;;;### (autoloads nil "cedet-autogen" "cedet-autogen.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "cedet-autogen" '("cedet-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "cedet-compat" '("cedet-")))
...
;;;***

;;;### (autoloads nil "cedet-utests" "cedet-utests.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "cedet-utests" '("cedet-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mode-local" '("activate-mode-local-bindings" "deactivate-mode-local-bindings" "def" "describe-mode-local-bindings" "fetch-overload" "function-overload-p" "get-mode-local-parent" "make-obsolete-overload" "mode-local-" "new-mode-local-bindings" "overload-" "set" "with-mode-local")))
...
;;;***

;;;### (autoloads nil nil ("cedet-load.el") (0 0 0 0))
